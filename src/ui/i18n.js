...
(function (global) {
  ...
  var zh = {
    ...
    home_note_story: '以上为代表字形选览，省略了部分阶段，并非完整或唯一的线性演变链；古文字素材的版本授权仍待核对。',
    ...
    help_health_chars: '检测 {{n}} 字；现有 {{s}} 个古文字资料槽位中 {{a}} 个有字形，{{m}} 个缺失；{{p}} 个已收录槽位的授权标记待确认。',
  ...
  var en = {
    ...
    home_note_story: 'A selection of representative glyphs with stages omitted — not a complete or single line of evolution; material licensing is still being verified.',
    ...
    help_health_chars: '{{n}} characters checked. Of {{s}} ancient-glyph slots, {{a}} have glyphs, {{m}} are missing; licensing is pending for {{p}} covered slots.',
